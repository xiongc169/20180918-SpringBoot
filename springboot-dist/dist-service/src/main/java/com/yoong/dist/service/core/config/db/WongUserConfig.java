...
//        DataSourceProperties wongUserDataSourceProperties = wongUserDataSourceProperties();
//        HikariDataSource hikariDataSource = wongUserDataSourceProperties().initializeDataSourceBuilder().type(HikariDataSource.class).build();
...
//        DataSourceTransactionManager transactionManager = new DataSourceTransactionManager(wongUserDataSource);
